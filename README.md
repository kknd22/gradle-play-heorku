...
JAVA_OPTS="-XX:MaxPermSize=128m -Xmx334m -Xss512k -XX:+UseCompressedOops -Dnewrelic.bootstrap_classpath=true -javaagent:target/staged/lib/com.newrelic.agent.java.newrelic-agent-3.21.0.jar"